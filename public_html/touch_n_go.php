...
<html>
  ...
  <title>Timeless Thrift - Touch 'n Go eWallet Payment</title>
  <style>
    .container {
      display: flex;
...
<body>
  ...
  <div class="container">
    <h1>Touch 'n Go eWallet Payment</h1>
    <div class="payment-form">
      <div class="picture-frame">
        <img src="payment_icons/touch_n_go_code.png" alt="Touch 'n Go E-wallet QR Code">
      </div>
      <p>Scan the QR code from your Touch 'n Go eWallet to proceed with the payment or transfer the amount manually to the following account number:</p>
      <p>3254 8743 3458 62</p>
