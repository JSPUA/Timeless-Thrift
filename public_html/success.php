...
<html>
  ...
  <title>Timeless Thrift - Success</title>
  <style>
    .container {
      display: flex;
...
<body>
  ...
  <div class="container">
    <div class="success-message">
      <img src="payment_icons/success.png" alt="Success Image" class="success-image">
      <h2>Order Placed Successfully!</h2>
      <p>Thank you for your purchase. Your order has been placed successfully.</p>
      <button class="back-to-home-button" onclick="window.location.href='index.php';">Back to Home</button>
    </div>
  </div>
</body>
</html>
